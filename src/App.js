    ...
    <div className="App">
      ...
      <div className='todo-wrapper'>
        ...
        <div className='todo-input'>
          ...
          <div className='todo-input-item'>
            <button type='button' onClick={handleAddTodo} className='pimary-btn'>Add</button>
          </div>
        </div>
          ...
          {isCompleteScreen === false && allTodos.map((item, index) => {
            return (
              <div className='todo-list-item' key={index}>
                ...
                <div className='icons'>
                  <i class="fa-solid fa-trash" onClick={() => handleDeleteTodo(index)}></i>
                  <i class="fa-solid fa-check" onClick={() => handleComplete(index)}></i>
                </div>
          ...
          {isCompleteScreen === true && completedTodos.map((item, index) => {
            return (
              <div className='todo-list-item' key={index}>
                ...
                <div className='icons'>
                  <i class="fa-solid fa-trash" onClick={() => handleDeleteCompletedTodo(index)}></i>
                </div>
